...
def process_and_merge_two_files_interactive():
    ...
    try:
        ...
        # 检查ID范围
        id1_min, id1_max = df1['ID'].min(), df1['ID'].max()
        ...
        df3 = pd.read_csv('dataset_agg_19.csv')
        print("########################################")
        print(f"   行数: {len(df3)}")
